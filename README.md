...
Ansvarsområden:
1.Data & EDA (target-fördelning, missing values, 2 figurer + insikter)
2.Pipeline & preprocessing (leakage-säker, hantering av numeriskt/kategoriskt, reproducibility)
3.Modelljämförelse (baseline + minst 2 modeller, CV-upplägg)
4.Optimering (tuning av 1 vald modell, 1–2 parametrar)
